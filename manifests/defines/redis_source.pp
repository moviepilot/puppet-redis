define redis_source(
    ...
    case $version {
        default: {
             ...
             exec { redis_code: 
                  command =>"wget https://github.com/antirez/redis/tarball/${version} --no-check-certificate -O redis_${version}.tar.gz && tar --strip-components 1 -xzvf redis_${version}.tar.gz",
